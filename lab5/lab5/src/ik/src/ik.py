...
def ik_service_client():
    ...
    pose_stamped.pose.position.x = float(input('Please enter desired x position: '))
    pose_stamped.pose.position.y = float(input('Please enter desired y position: '))
    pose_stamped.pose.position.z = float(input('Please enter desired z position: '))

    # Set end effector quaternion: YOUR CODE HERE
    pose_stamped.pose.orientation.x = float(input('Please enter desired x orientation: '))
    pose_stamped.pose.orientation.y = float(input('Please enter desired y orientation: '))
    pose_stamped.pose.orientation.z = float(input('Please enter desired z orientation: '))
    pose_stamped.pose.orientation.w = float(input('Please enter desired w orientation: '))
